...
class Provision(Document):
	def before_save(self):
		if not self.details:
			frappe.db.sql(
				"""
				INSERT INTO `tabProvision Details`(annee, mois, periode_date_begin, periode_date_end, date_join, date_begin, date_end, date_quit, employee, new_rate, period_days, rate, salaire, start_period_days, years_difference, year_div_5, categorie)
				SELECT t.annee, t.mois, t.date_begin, t.date_end, t.date_join, t.date_debut, t.date_fin, t.date_quit, t.name,
					(t.start_period_day / t.period_day * t.rate) + t.years_div_5 AS new_rate, t.period_day, t.rate, t.salaire, t.start_period_day, t.years_difference, t.year_div_5, t.categorie
				FROM (
					SELECT 
						e.name, 
